...
<div class="form-check" style="margin-bottom: 5px;">
            <input class="form-check-input" type="checkbox" id="formCheck-4" name="brand[]" value="Vitz">
            <label class="form-check-label" for="formCheck-4">Vitz</label>
</div>
<div class="form-check" style="margin-bottom: 5px;">
...
<div class="form-check" style="margin-bottom: 5px;">
            <input class="form-check-input" type="checkbox" id="formCheck-2" name="brand[]" value="Passo">
            <label class="form-check-label" for="formCheck-2">Passo</label>
</div>
