...
<body>
    ...
    <div class="row" style="margin-right: 35px;margin-left: 35px;margin-bottom: 30px;">
        <div class="col" style="padding: 15px;padding-top: 15px;width: 95%;max-width: 100%;padding-right: 15px;padding-left: 15px;border-style: solid;border-color: rgba(33,37,41,0.21);border-radius: 10px;margin: 5px;">
            ...
            <div class="container" style="border-bottom-style: solid;border-bottom-color: rgba(33,37,41,0.21);padding-bottom: 3px;padding-top: 5px;margin-bottom: 20px;">
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-md-4 col-xxl-4 d-xxl-flex align-items-xxl-center">
                        <div>
                            ...
                            <h4 style="font-size: 25px;">Car '.$row['title'].'</h4>
                        </div>
                    </div>
                    <div class="col-md-4 col-xxl-4 d-xxl-flex align-items-xxl-center">
                        <div>
                    ...
                    <div class="col-md-4 col-xxl-1 d-xxl-flex align-items-xxl-center" style="padding-left: 1px;margin-bottom: -12px;">
                        <div><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-down-circle-fill" style="font-size: 38px;color: var(--bs-green);" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                            ...
                            </svg><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" style="font-size: 38px;color: var(--bs-red);margin-left: 15px;" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div id="collapseExample" class="collapse">
                    <div class="card" style="border-radius: 17px;">
                        <div class="card-body" style="padding-top: 20px;padding-bottom: 20px;">
                            ...
                            <h6 class="text-muted card-subtitle mb-2">Customer / Car Owner</h6>
    ...
    <div class="row" style="margin-right: 35px;margin-left: 35px;margin-bottom: 30px;">
        ...
        <div class="col" style="padding: 15px;padding-top: 15px;width: 95%;max-width: 100%;padding-right: 15px;padding-left: 15px;border-style: solid;border-color: rgba(33,37,41,0.21);border-radius: 10px;margin: 5px;height: 225.5px;">
            ...
            <div class="container d-xxl-flex justify-content-xxl-center align-items-xxl-end" style="height: 98px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-192 0 512 512" width="1em" height="1em" fill="currentColor" style="font-size: 56px;color: var(--bs-gray-500);">
                    <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                    <path d="M64 352c17.69 0 32-14.32 32-31.1V64.01c0-17.67-14.31-32.01-32-32.01S32 46.34 32 64.01v255.1C32 337.7 46.31 352 64 352zM64 400c-22.09 0-40 17.91-40 40s17.91 39.1 40 39.1s40-17.9 40-39.1S86.09 400 64 400z"></path>
                </svg></div>
            <div class="container d-xxl-flex justify-content-xxl-center"><small style="color: var(--bs-gray-500);">No Messages</small></div>
