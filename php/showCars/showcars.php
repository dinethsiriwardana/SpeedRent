...
if (mysqli_num_rows($result) > 0) 
{
  // output data of each row
    while($row = mysqli_fetch_assoc($result)) 
    {
      ...
      <div class="row">
          <div class="col-xxl-5" style="width: 50%;"><img src="assets/img/'. $row['carid'] .'" width="80%" style="width: 100%;"></div>
          <div class="col-xxl-5" style="width: 50%;"><small class="d-xl-flex justify-content-xl-end" style="font-size: 30px;">$'.$row['price'].'</small><small class="d-xl-flex justify-content-xl-end align-items-xl-center" style="font-size: 15px;margin-top: -12px;color: rgba(33,37,41,0.52);">per day</small>
