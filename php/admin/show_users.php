...
$sql = "SELECT CONCAT(ua.fname, ' ', ua.lname) AS full_name, ua.uid, SUM(ro.price) AS total_amount FROM rent_order ro JOIN user_accounts ua ON ro.uid = ua.uid GROUP BY ua.fname, ua.lname, ua.uid;";
