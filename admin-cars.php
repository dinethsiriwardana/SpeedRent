...
<body>
    ...
    <form action="php/add_car.php" enctype="multipart/form-data" method="post">
            ...
            <div class="row d-xxl-flex align-items-xxl-center" style="padding-bottom: 15px;padding-top: 10px;border-bottom-style: solid;border-bottom-color: rgba(33,37,41,0.16);">
                <div class="col">
                    <div class="row row-cols-xl-2 row-cols-xxl-2">
                        <div class="col-lg-5 col-xl-4 col-xxl-4 d-lg-flex d-xl-flex flex-column justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-start justify-content-xxl-center align-items-xxl-center" style="border-right-style: solid;border-right-color: rgba(33,37,41,0.3);"><img class="d-flex justify-content-center" src="assets/img/ef3-placeholder-image.jpg" style="width: 100%;min-width: auto;border-radius: 15px;border: 1px dashed var(--bs-gray-500);margin-bottom: 12px;" width="auto" height="auto"><input class="form-control" type="file" id="fileToUpload" name="fileToUpload"></div>
                        <div class="col-lg-7 col-xl-8 col-xxl-8 d-lg-flex d-xl-flex flex-column align-items-lg-center justify-content-xl-center align-items-xl-start align-items-xxl-center">
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3" style="width: 100%;margin-bottom: 10px;">
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Car Band</h6><select class="form-select" style="width: 100%;height: 35px;padding-left: 5px;">
                                ...
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Car Model</h6><select class="form-select" style="width: 100%;height: 35px;padding-left: 5px;">
                                        <optgroup label="This is a group">
                                            <option value="12" selected="">This is item 1</option>
                                            <option value="13">This is item 2</option>
                                            <option value="14">This is item 3</option>
                                ...
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Number Plate</h6><input class="form-control" type="text" style="width: 100%;height: 35px;text-align: right;padding-right: 5px;" placeholder="AAA - 1234">
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3" style="width: 100%;padding-bottom: 10px;">
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Price Per Hour</h6><input class="form-control" type="number" style="width: 100%;height: 35px;text-align: right;" value="0.0" required="">
                                </div>
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);"># of Seat</h6><input class="form-control" type="number" style="width: 100%;height: 35px;text-align: right;" value="2">
                                </div>
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Ownership</h6>
                                    <div class="row" style="width: 100%;">
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-2"><label class="form-check-label" for="formCheck-2">Our</label></div>
                                        </div>
                                        <div class="col">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"><label class="form-check-label" for="formCheck-1">Others</label></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3 visible" style="width: 100%;padding-bottom: 10px;">
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Owners Name</h6><input class="form-control" type="text" style="width: 100%;height: 35px;text-align: right;padding-right: 5px;" placeholder="Owners Name">
                                </div>
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Owners ID</h6><input class="form-control" type="text" style="width: 100%;height: 35px;text-align: right;padding-right: 5px;" placeholder="ID No">
                                </div>
                                <div class="col d-xl-flex flex-column justify-content-xl-center align-items-xl-start">
                                    <h6 class="text-muted mb-2" style="font-size: 15px;color: rgba(0,0,0,0.25);">Owners Tel No</h6><input class="form-control" type="text" style="width: 100%;height: 35px;text-align: right;padding-right: 5px;" placeholder="Tel No">
                                </div>
                            </div>
                            <div class="text-end d-lg-flex d-xxl-flex justify-content-lg-end justify-content-xxl-end" style="width: 100%;margin-top: 15px;margin-right: 20px;"><button class="btn btn-success" type="submit" style="background: var(--bs-red);border-style: none;">Add a Car</button></div>
                        </div>
                    </div>
                </div>
            </div>
